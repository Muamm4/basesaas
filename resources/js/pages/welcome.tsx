        ...
        <div className="relative w-full max-w-4xl text-center space-y-8 z-10">
          ...
          {auth.user ? (
            <div className="space-y-4">
              <Link
                href="/dashboard"
                className="inline-flex items-center justify-center px-8 py-3 rounded-lg bg-primary dark:hover:bg-gray-700 hover:bg-primary/90 dark:text-gray-800 dark:hover:text-white font-medium transition-all transform hover:-translate-y-0.5 shadow-md hover:shadow-lg"
              >
                Go to Dashboard
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              ...
              <Link
                href="/register"
                className="px-8 py-3 rounded-lg bg-primary text-white font-medium dark:bg-gray-100 dark:hover:bg-gray-700 hover:bg-primary/90 dark:text-gray-800 dark:hover:text-white transition-all transform hover:-translate-y-0.5 shadow-md hover:shadow-lg"
              >
                Get Started
              </Link>
            </div>
