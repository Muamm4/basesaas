  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      ...
      <div className="flex-1 p-4 md:p-6 grid grid-cols-1 md:grid-cols-4 gap-6">
        {/* Sidebar Folder Tree */}
        <div className="md:col-span-1 border rounded-lg p-4 bg-white dark:bg-gray-800">
          ...
          <div className="overflow-y-auto max-h-[calc(100vh-250px)]">
            <div
              className={`flex items-center gap-2 cursor-pointer hover:bg-gray-100 p-2 rounded mb-2 dark:text-white dark:bg-gray-700 dark:hover:bg-gray-600 ${!currentFolderId ? 'bg-gray-100 dark:bg-gray-700' : ''}`}
              onClick={() => router.visit('/files')}
            >
              <FolderRoot className="w-4 h-4 text-blue-500 dark:text-blue-400" />
