                    ...
                    <CardContent className="pt-6">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-1">
                                <Label htmlFor="name_app">Application Name</Label>
                                <Input
                                    id="name_app"
                                    value={data.name_app}
                                    onChange={(e) => setData('name_app', e.target.value)}
                                    className={errors.name_app ? 'border-red-500' : ''}
                                />
                                {errors.name_app && <p className="text-sm text-red-500">{errors.name_app}</p>}
                            </div>
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <Button
                                        ...
                                        variant="secondary"
                                        size="sm"
                                        onClick={() => setData('color', DEFAULT_WARNA)}
                                    >
                                        Reset Default
                                    </Button>
                                </div>
